...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { district_id: @rate.district_id, district_id: @rate.district_id, name: @rate.name, price: @rate.price }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { district_id: @rate.district_id, district_id: @rate.district_id, name: @rate.name, price: @rate.price }
    assert_redirected_to rate_path(assigns(:rate))
  end
