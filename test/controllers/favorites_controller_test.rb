...
class FavoritesControllerTest < ActionController::TestCase
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post :create, favorite: { address_id: @favorite.address_id, name: @favorite.name, person_id: @favorite.person_id }
    end
  ...
  test "should update favorite" do
    patch :update, id: @favorite, favorite: { address_id: @favorite.address_id, name: @favorite.name, person_id: @favorite.person_id }
    assert_redirected_to favorite_path(assigns(:favorite))
  end
